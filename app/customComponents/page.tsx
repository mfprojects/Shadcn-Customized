...
export default function CustomComponents() {
  return (
    <div className="flex flex-col w-full px-0 mx-auto bg-indigo-100">
      <div className="flex-grow flex flex-col w-full bg-gradient-to-t from-[#0a2855] from-10% to-[#051937] to-100% shadow-indigo-500/50 shadow-custom-lg p-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-2 pb-12 sm:px-4">
          ...
          <div className="space-y-4">
            <div className="flex-1  rounded-lg shadow-highlight2 bg-background-gradient-component border-2 border-borderColor">

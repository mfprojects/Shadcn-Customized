...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen p-0 lg:p-8 bg-mainColor">
      <Nav />
      <div className="flex flex-col justify-evenly min-h-screen shadow-indigo-500/50 shadow-custom-lg p-4">
        ...
        <div className="flex flex-wrap justify-evenly content-center gap-4 sm:gap-4 pt-12 mt-4  ">
          <div className="flex-1 flex flex-col items-start sm:justify-center p-4 rounded-lg bg-background-gradient-component-small sm:bg-background-gradient-component">
            ...
            <div className="flex-1 flex justify-center items-end w-full gap-4 py-12 xsplus:py-8 sm:py-8">
              <Button
                size="lg"
